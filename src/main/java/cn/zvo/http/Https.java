...
public class Https {
     ...
     * @param encode 使用时首先会自动获取请求地址的编码，获取编码失败时才会使用此处的编码<p> {@link Http#UTF8} {@link Http#GBK}</p>
     */
    public Https(String encode) { 
        this.encode = encode; 
    } 
	...
	public static void main(String[] args) {
		...
		Response hr = h.post("https://api.weixin.qq.com/cgi-bin/message/wxopen/template/send?access_token=123", param);
     ...
     * @return {@link Response}
     */
    public Response post(String url,Map<String, String> parameters,Map<String, String> headers){
    	try {
			return send(url, Http.mapToQueryString(parameters), headers);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
    ...
    public Response post(String url,Map<String, String> parameters){
    	try {
			return send(url, Http.mapToQueryString(parameters), new HashMap<String, String>());
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
     ...
     * @throws Exception 异常
     */
    public Response send(String url,String post,Map<String, String> headers) throws Exception {
     ...
     * @throws IOException
     */ 
    public Response makeContent(String urlString, HttpURLConnection urlConnection, String content) throws IOException { 
